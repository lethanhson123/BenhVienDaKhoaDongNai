...
@Component({
  selector: 'app-phong-kham-name',
  templateUrl: './phong-kham-name.component.html',
  styleUrls: ['./phong-kham-name.component.css']
})
export class PhongKhamNameComponent implements OnInit {
  ...
  DanhMucPhongKhamSearch() {
    if (this.DanhMucPhongKhamService.BaseParameter.SearchString.length > 0) {
      ...
      this.DanhMucPhongKhamService.GetSQLBySearchStringViaNameToListAsync().subscribe(
        res => {
