...
export class Log_UpdateInformationService extends BaseService{
    DisplayColumns001: string[] = ['Save', 'STT', 'Update_ID', 'UpdateData_TableName', 'UpdateData_Id', 'UpdateData_Code', 'UpdateDate', 'UpdateDateTime', 'UpdateDay', 'UpdateMonth', 'UpdateYear', 'UpdateSecond', 'UpdateMinute', 'UpdateHour', 'User_Id', 'LoginSession_Id'];
