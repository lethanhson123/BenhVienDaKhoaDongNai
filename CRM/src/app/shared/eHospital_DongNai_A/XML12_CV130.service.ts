...
export class XML12_CV130Service extends BaseService{
    DisplayColumns001: string[] = ['STT', 'XML12_CV130_Id', 'BenhAn_Id', 'TiepNhan_Id', 'BenhNhan_Id', 'XacNhanChiPhi_Id', 'NGUOI_CHU_TRI', 'CHUC_VU', 'NGAY_HOP', 'HO_TEN', 'NGAY_SINH', 'SO_CCCD', 'NGAY_CAP_CCCD', 'NOI_CAP_CCCD', 'DIA_CHI', 'MATINH_CU_TRU', 'MAHUYEN_CU_TRU', 'MAXA_CU_TRU', 'MA_BHXH', 'MA_THE_BHYT', 'NGHE_NGHIEP', 'DIEN_THOAI', 'MA_DOI_TUONG', 'KHAM_GIAM_DINH', 'SO_BIEN_BAN', 'TYLE_TTCT_CU', 'DANG_HUONG_CHE_DO', 'NGAY_CHUNG_TU', 'SO_GIAY_GIOI_THIEU', 'NGAY_DE_NGHI', 'MA_DONVI', 'GIOI_THIEU_CUA', 'KET_QUA_KHAM', 'SO_VAN_BAN_CAN_CU', 'TYLE_TTCT_MOI', 'TONG_TYLE_TTCT', 'DANG_KHUYETTAT', 'MUC_DO_KHUYETTAT', 'DE_NGHI', 'DUOC_XACDINH', 'DU_PHONG'];
