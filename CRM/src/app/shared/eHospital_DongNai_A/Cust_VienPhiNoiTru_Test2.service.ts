...
import { Cust_VienPhiNoiTru_Test2 } from './Cust_VienPhiNoiTru_Test2.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class Cust_VienPhiNoiTru_Test2Service extends BaseService{
    ...
    List: Cust_VienPhiNoiTru_Test2[] | undefined;
    ListFilter: Cust_VienPhiNoiTru_Test2[] | undefined;
    FormData!: Cust_VienPhiNoiTru_Test2;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "Cust_VienPhiNoiTru_Test2";
    }
}
