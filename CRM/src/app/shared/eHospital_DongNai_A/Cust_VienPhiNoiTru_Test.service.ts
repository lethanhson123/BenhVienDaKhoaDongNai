...
import { Cust_VienPhiNoiTru_Test } from './Cust_VienPhiNoiTru_Test.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class Cust_VienPhiNoiTru_TestService extends BaseService{
    ...
    List: Cust_VienPhiNoiTru_Test[] | undefined;
    ListFilter: Cust_VienPhiNoiTru_Test[] | undefined;
    FormData!: Cust_VienPhiNoiTru_Test;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "Cust_VienPhiNoiTru_Test";
    }
}
