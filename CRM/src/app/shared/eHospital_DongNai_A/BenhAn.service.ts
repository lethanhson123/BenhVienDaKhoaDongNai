...
export class BenhAnService extends BaseService{
    ...
    DisplayColumns002: string[] = ['STT', 'NgayTao', 'NguoiTao_Id', 'NgayCapNhat', 'NguoiCapNhat_Id', 'BenhAn_Id', 'SoBenhAn', 'SoLuuTru', 'LoaiBenhAn_Id', 'TrangThai', 'BenhNhan_Id', 'DoiTuong_Id', 'ThoiGianVaoVien', 'ThoiGianRaVien', 'NoiLap_Id', 'KhoaVao_Id', 'KhoaRa_Id', 'BacSiDieuTriChinh_Id', 'ICD_VaoKhoa', 'ChanDoanVaoKhoa'];
