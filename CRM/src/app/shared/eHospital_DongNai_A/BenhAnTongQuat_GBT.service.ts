...
import { BenhAnTongQuat_GBT } from './BenhAnTongQuat_GBT.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class BenhAnTongQuat_GBTService extends BaseService{
    ...
    List: BenhAnTongQuat_GBT[] | undefined;
    ListFilter: BenhAnTongQuat_GBT[] | undefined;
    FormData!: BenhAnTongQuat_GBT;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "BenhAnTongQuat_GBT";
    }
}
