...
import { Base } from 'src/app/shared/eHospital_DongNai_A_System/Base.model';
import { BaseParameter } from 'src/app/shared/eHospital_DongNai_A_System/BaseParameter.model';
@Injectable({
    providedIn: 'root'
})
export class BaseService {
    ...
    APIURL: string = environment.API_eHospital_DongNai_A_SystemURL;
