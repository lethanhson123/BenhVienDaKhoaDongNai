...
@Component({
  selector: 'app-kham-benh-vao-vien-info',
  templateUrl: './kham-benh-vao-vien-info.component.html',
  styleUrls: ['./kham-benh-vao-vien-info.component.css']
})
export class KhamBenhVaoVienInfoComponent implements OnInit {
  ...
  KhamBenh_VaoVienSave() {
    ...
    this.KhamBenh_VaoVienService.SaveAsync().subscribe(
      res => {
        this.KhamBenh_VaoVienService.FormData = res as KhamBenh_VaoVien;
        this.Router.navigateByUrl(environment.KhamBenhVaoVienInfo + this.KhamBenh_VaoVienService.FormData.KhamBenhVaoVien_Id);
