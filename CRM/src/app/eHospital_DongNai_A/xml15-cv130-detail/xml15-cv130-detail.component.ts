...
@Component({
  selector: 'app-XML15-cv130-detail',
  templateUrl: './XML15-cv130-detail.component.html',
  styleUrls: ['./XML15-cv130-detail.component.css']
})
export class XML15CV130DetailComponent implements OnInit {

  constructor(
    public DialogRef: MatDialogRef<XML15CV130DetailComponent>,
