...
@Component({
  selector: 'app-XML14-cv130-detail',
  templateUrl: './XML14-cv130-detail.component.html',
  styleUrls: ['./XML14-cv130-detail.component.css']
})
export class XML14CV130DetailComponent implements OnInit {

  constructor(
    public DialogRef: MatDialogRef<XML14CV130DetailComponent>,
