...
@Component({
  selector: 'app-sys-app-private-settings',
  templateUrl: './sys-app-private-settings.component.html',
  styleUrls: ['./sys-app-private-settings.component.css']
})
export class SysAppPrivateSettingsComponent implements OnInit {
