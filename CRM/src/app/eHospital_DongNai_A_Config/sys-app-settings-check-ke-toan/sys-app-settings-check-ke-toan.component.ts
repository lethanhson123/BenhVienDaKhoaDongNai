...
@Component({
  selector: 'app-sys-app-settings-check-ke-toan',
  templateUrl: './sys-app-settings-check-ke-toan.component.html',
  styleUrls: ['./sys-app-settings-check-ke-toan.component.css']
})
export class SysAppSettingsCheckKeToanComponent implements OnInit {
  ...
  Sys_AppSettingsSearch() {
    ...
    this.Sys_AppSettingsService.BaseParameter.SearchString = environment.CheckBHXHKeToan;
