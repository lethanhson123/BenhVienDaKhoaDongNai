namespace Service.Interface
{
        ...
        where T : class
    {
        ...
        List<T> GetByParentID_SearchStringToList(long parentID, string searchString);
        Task<List<T>> GetByParentID_SearchStringToListAsync(long parentID, string searchString);
        List<T> GetByDanhMucUngDungID_SearchStringToList(long DanhMucUngDungID, string searchString);
        Task<List<T>> GetByDanhMucUngDungID_SearchStringToListAsync(long DanhMucUngDungID, string searchString);
        ...
        List<T> GetByPageAndPageSizeAndIDToList(int page, int pageSize, long ID);
        Task<List<T>> GetByPageAndPageSizeAndIDToListAsync(int page, int pageSize, long ID);
        List<T> GetByActiveAndPageAndPageSizeAndIDToList(bool Active, int page, int pageSize, long ID);
        Task<List<T>> GetByActiveAndPageAndPageSizeAndIDToListAsync(bool Active, int page, int pageSize, long ID);
        ...
        Task<List<T>> GetByDanhMucUngDungIDAndEmptyToListAsync(long DanhMucUngDungID);
        List<T> GetByDanhMucUngDungID_SearchString_EmptyToList(long DanhMucUngDungID, string SearchString);
        Task<List<T>> GetByDanhMucUngDungID_SearchString_EmptyToListAsync(long DanhMucUngDungID, string SearchString);
        List<T> GetByParentIDAndDanhMucUngDungIDAndEmptyToList(long parentID, long DanhMucUngDungID);
        Task<List<T>> GetByParentIDAndDanhMucUngDungIDAndEmptyToListAsync(long parentID, long DanhMucUngDungID);
        List<T> GetByParentIDAndActiveAndEmptyToList(long parentID, bool active);
        Task<List<T>> GetByParentIDAndActiveAndEmptyToListAsync(long parentID, bool active);
        List<T> GetByLastUpdatedMembershipIDAndEmptyToList(long lastUpdatedMembershipID);
        Task<List<T>> GetByLastUpdatedMembershipIDAndEmptyToListAsync(long lastUpdatedMembershipID);
