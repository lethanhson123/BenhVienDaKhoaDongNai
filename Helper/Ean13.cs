namespace Helper
{
    public class Ean13
    {
        ...
        public Ean13()
        {
            _sCountryCode = GlobalHelper.EAN13CountryCode;
            _sManufacturerCode = GlobalHelper.EAN13ManufacturerCode;
        }
        ...
        public static string CreateEAN13Image(string ProductCode, string FTP)
        {
        ...
        public static Barcode CreateEAN13(string FTP)
        {
            ...
            Ean13 ean13 = new Ean13();
            ean13.CountryCode = result.Number.Substring(0, 2);
            ean13.ManufacturerCode = result.Number.Substring(2, 6);
            ean13.ProductCode = result.Number.Substring(6, 4);
            ean13.Scale = 8;
            System.Drawing.Bitmap bmp = ean13.CreateBitmap();
            result.Code = ean13.CountryCode + ean13.ManufacturerCode + ean13.ProductCode + ean13.ChecksumDigit;
            string fileName = result.Code + ".png";
            FTP = FTP + "/" + fileName;
            bmp.Save(FTP, ImageFormat.Png);
            if (equals == true)
            {
