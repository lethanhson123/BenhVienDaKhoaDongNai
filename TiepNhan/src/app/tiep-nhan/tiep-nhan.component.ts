...
export class TiepNhanComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    URL = environment.TiepNhanURL + URL + "/" + this.ActiveRouter.snapshot.params.DanhMucDichVuID + "/" + this.ActiveRouter.snapshot.params.DanhMucQuayDichVuID;
  ...
  GoiSoTiepTheo() {
    ...
    this.GoiSoService.GoiSoTiepTheoByDanhMucDichVuIDAsync().subscribe(
      res => {
