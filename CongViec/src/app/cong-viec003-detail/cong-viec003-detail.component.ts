...
@Component({
  selector: 'app-cong-viec003-detail',
  templateUrl: './cong-viec003-detail.component.html',
  styleUrls: ['./cong-viec003-detail.component.css']
})
export class CongViec003DetailComponent implements OnInit {

  constructor(
    private Dialog: MatDialog,
    public DialogRef: MatDialogRef<CongViec003DetailComponent>,
