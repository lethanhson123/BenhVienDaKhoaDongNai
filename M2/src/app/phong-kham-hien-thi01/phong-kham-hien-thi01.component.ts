...
@Component({
  selector: 'app-phong-kham-hien-thi01',
  templateUrl: './phong-kham-hien-thi01.component.html',
  styleUrls: ['./phong-kham-hien-thi01.component.css']
})
export class PhongKhamHienThi01Component implements OnInit {
  ...
  DanhMucPhongKhamSearch() {
    this.DanhMucPhongKhamService.BaseParameter.Name = this.ActiveRouter.snapshot.params.Name;
