...
@Component({
  selector: 'app-m60',
  templateUrl: './m60.component.html',
  styleUrls: ['./m60.component.css']
})
export class M60Component implements OnInit {
          ...
          if (this.DanhMucQuayDichVuService.FormData05.ID > 0) {            
            ...
            this.GoiSoChiTietService.GetGoiSoChiTietTiepNhan07ToListAsync().subscribe(
              res => {
                ...
                this.GoiSoChiTietService.List44 = this.GoiSoChiTietService.List.filter(item => item.Active == false && item.IsUuTien == true).sort((a, b) => (a.NgayCapSoSoThuTu > b.NgayCapSoSoThuTu ? 1 : -1));
                for (let i = 0; i < this.GoiSoChiTietService.List44.length; i++) {
                  if (this.GoiSoChiTietService.List44[i].NgayCapSoSoThuTuString) {
                  }
                  else {
          ...
          if (this.DanhMucQuayDichVuService.FormData06.ID > 0) {      
            ...
            this.GoiSoChiTietService.GetGoiSoChiTietTiepNhan07ToListAsync().subscribe(
              res => {
                ...
                this.GoiSoChiTietService.List54 = this.GoiSoChiTietService.List.filter(item => item.Active == false && item.IsUuTien == true).sort((a, b) => (a.NgayCapSoSoThuTu > b.NgayCapSoSoThuTu ? 1 : -1));
                for (let i = 0; i < this.GoiSoChiTietService.List54.length; i++) {
                  if (this.GoiSoChiTietService.List54[i].NgayCapSoSoThuTuString) {
                  }
                  else {
