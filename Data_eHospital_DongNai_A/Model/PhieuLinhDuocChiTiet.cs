...
{
    public partial class PhieuLinhDuocChiTiet : BaseModel
    {
        [Key]
...
public int? ChungTuHoanTra_Le_Id { get; set; }
public decimal? SoLuongThucNhan { get; set; }
public string? SoLuongTongHopThucTe { get; set; }

        public PhieuLinhDuocChiTiet()
        {
        }
    }
}
