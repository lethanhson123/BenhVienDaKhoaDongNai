...
{
    public partial class BenhAnTongQuat_Mat : BaseModel
    {
        [Key]
...
public string? Field_66 { get; set; }

        public BenhAnTongQuat_Mat()
        {
        }
    }
}
