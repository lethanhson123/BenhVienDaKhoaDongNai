    ...
    public class DownloadController : BaseController<XML1_CV130, IXML1_CV130Service>
    {
        ...
        public virtual async Task<JsonResult> CreateXMLCV130Async()
        {
            ...
            try
            {
                ...
                string XML1NOIDUNGFILE = CreateXML1(ListXML1_CV130, XMLCV130Tag);
                string XML2NOIDUNGFILE = CreateXML2(ListXML2_CV130, XMLCV130Tag);
                string XML3NOIDUNGFILE = CreateXML3(ListXML3_CV130, XMLCV130Tag);
                string XML4NOIDUNGFILE = CreateXML4(ListXML4_CV130, XMLCV130Tag);
                string XML5NOIDUNGFILE = CreateXML5(ListXML5_CV130, XMLCV130Tag);
                string XML6NOIDUNGFILE = CreateXML6(ListXML6_CV130, XMLCV130Tag);
                string XML7NOIDUNGFILE = CreateXML7(ListXML7_CV130, XMLCV130Tag);
                string XML8NOIDUNGFILE = CreateXML8(ListXML8_CV130, XMLCV130Tag);
                string XML9NOIDUNGFILE = CreateXML9(ListXML9_CV130, XMLCV130Tag);
                string XML10NOIDUNGFILE = CreateXML10(ListXML10_CV130, XMLCV130Tag);
                string XML11NOIDUNGFILE = CreateXML11(ListXML11_CV130, XMLCV130Tag);
                string XML12NOIDUNGFILE = CreateXML12(ListXML12_CV130, XMLCV130Tag);
                string XML13NOIDUNGFILE = CreateXML13(ListXML13_CV130, XMLCV130Tag);
                string XML14NOIDUNGFILE = CreateXML14(ListXML14_CV130, XMLCV130Tag);
        ...
        private string CreateXML1(List<XML1_CV130> List, XMLCV130Tag XMLCV130Tag)
        {
            ...
            foreach (XML1_CV130 item in List)
            {
