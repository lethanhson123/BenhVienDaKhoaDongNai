namespace API_eHospital_DongNai_A.Controllers.v1
{
    ...
    public class XML3_CV130Controller : BaseController<XML3_CV130, IXML3_CV130Service>
    {
        ...
        public virtual async Task<List<XML3_CV130>> GetByYear_Month_SearchStringToListAsync()
        {
            List<XML3_CV130> result = new List<XML3_CV130>();
            try
            {
                BaseParameter baseParameter = JsonConvert.DeserializeObject<BaseParameter>(Request.Form["data"]);
                result = await _XML3_CV130Service.GetByYear_Month_SearchStringToListAsync(baseParameter.Year.Value, baseParameter.Month.Value, baseParameter.SearchString);
            }
            catch (Exception ex)
            {
        ...
        public virtual async Task<List<XML3_CV130>> GetByListIDStringToListAsync()
        {
            List<XML3_CV130> result = new List<XML3_CV130>();
            try
            {
                BaseParameter baseParameter = JsonConvert.DeserializeObject<BaseParameter>(Request.Form["data"]);
                result = await _XML3_CV130Service.GetByListIDStringToListAsync(baseParameter.ListIDString);
            }
            catch (Exception ex)
            {
                string message = ex.Message;
