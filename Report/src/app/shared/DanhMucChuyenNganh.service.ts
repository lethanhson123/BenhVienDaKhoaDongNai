...
import { DanhMucChuyenNganh } from './DanhMucChuyenNganh.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class DanhMucChuyenNganhService extends BaseService{
    ...
    List: DanhMucChuyenNganh[] | undefined;
    ListFilter: DanhMucChuyenNganh[] | undefined;
    FormData!: DanhMucChuyenNganh;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "DanhMucChuyenNganh";
    }
}
