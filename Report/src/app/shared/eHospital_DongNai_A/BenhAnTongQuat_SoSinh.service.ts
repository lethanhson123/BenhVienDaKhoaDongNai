...
import { BenhAnTongQuat_SoSinh } from './BenhAnTongQuat_SoSinh.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class BenhAnTongQuat_SoSinhService extends BaseService{
    ...
    List: BenhAnTongQuat_SoSinh[] | undefined;
    ListFilter: BenhAnTongQuat_SoSinh[] | undefined;
    FormData!: BenhAnTongQuat_SoSinh;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "BenhAnTongQuat_SoSinh";
    }
}
