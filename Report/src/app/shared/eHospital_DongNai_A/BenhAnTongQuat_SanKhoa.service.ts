...
import { BenhAnTongQuat_SanKhoa } from './BenhAnTongQuat_SanKhoa.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class BenhAnTongQuat_SanKhoaService extends BaseService{
    ...
    List: BenhAnTongQuat_SanKhoa[] | undefined;
    ListFilter: BenhAnTongQuat_SanKhoa[] | undefined;
    FormData!: BenhAnTongQuat_SanKhoa;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "BenhAnTongQuat_SanKhoa";
    }
}
