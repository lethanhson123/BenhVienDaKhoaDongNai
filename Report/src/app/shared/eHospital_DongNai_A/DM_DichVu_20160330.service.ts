...
import { DM_DichVu_20160330 } from './DM_DichVu_20160330.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class DM_DichVu_20160330Service extends BaseService{
    ...
    List: DM_DichVu_20160330[] | undefined;
    ListFilter: DM_DichVu_20160330[] | undefined;
    FormData!: DM_DichVu_20160330;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "DM_DichVu_20160330";
    }
}
