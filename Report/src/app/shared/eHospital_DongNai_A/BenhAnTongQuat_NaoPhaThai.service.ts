...
import { BenhAnTongQuat_NaoPhaThai } from './BenhAnTongQuat_NaoPhaThai.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class BenhAnTongQuat_NaoPhaThaiService extends BaseService{
    ...
    List: BenhAnTongQuat_NaoPhaThai[] | undefined;
    ListFilter: BenhAnTongQuat_NaoPhaThai[] | undefined;
    FormData!: BenhAnTongQuat_NaoPhaThai;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "BenhAnTongQuat_NaoPhaThai";
    }
}
