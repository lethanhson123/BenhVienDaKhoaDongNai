...
import { DanhMucBangCap } from './DanhMucBangCap.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class DanhMucBangCapService extends BaseService{
    ...
    List: DanhMucBangCap[] | undefined;
    ListFilter: DanhMucBangCap[] | undefined;
    FormData!: DanhMucBangCap;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "DanhMucBangCap";
    }
}
