...
@Component({
  selector: 'app-dmdon-vi-hanh-chinh-xa-phuong',
  templateUrl: './dmdon-vi-hanh-chinh-xa-phuong.component.html',
  styleUrls: ['./dmdon-vi-hanh-chinh-xa-phuong.component.css']
})
export class DMDonViHanhChinhXaPhuongComponent implements OnInit {
  ...
  DM_DonViHanhChinhSearchQuanHuyen() {
    this.DM_DonViHanhChinhService.BaseParameter.CapTren_Id = this.DM_DonViHanhChinhService.BaseParameter.TinhThanh_Id;
  ...
  DM_DonViHanhChinhSearch() {
    if (this.DM_DonViHanhChinhService.BaseParameter.SearchString.length > 0) {
      ...
      this.DM_DonViHanhChinhService.BaseParameter.CapTren_Id = this.DM_DonViHanhChinhService.BaseParameter.QuanHuyen_Id;
      this.DM_DonViHanhChinhService.BaseParameter.CapDonVi = 4;
      this.DM_DonViHanhChinhService.GetByCapDonVi_CapTren_IdAndEmptyToListAsync().subscribe(
        res => {
