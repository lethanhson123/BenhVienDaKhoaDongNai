...
import { Sys_Parameters } from 'src/app/shared/eHospital_DongNai_A_System/Sys_Parameters.model';
import { Sys_ParametersService } from 'src/app/shared/eHospital_DongNai_A_System/Sys_Parameters.service';


@Component({
  selector: 'app-sys-parameters',
  templateUrl: './sys-parameters.component.html',
  styleUrls: ['./sys-parameters.component.css']
})
export class SysParametersComponent implements OnInit {
