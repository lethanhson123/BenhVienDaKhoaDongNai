...
@Component({
  selector: 'app-xml1-cv130-detail',
  templateUrl: './xml1-cv130-detail.component.html',
  styleUrls: ['./xml1-cv130-detail.component.css']
})
export class XML1CV130DetailComponent implements OnInit {

  constructor(    
    public DialogRef: MatDialogRef<XML1CV130DetailComponent>,
