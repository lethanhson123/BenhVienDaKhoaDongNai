...
@Component({
  selector: 'app-xml2-cv130',
  templateUrl: './xml2-cv130.component.html',
  styleUrls: ['./xml2-cv130.component.css']
})
export class XML2CV130Component implements OnInit {
  ...
  KhoiTao() {
    this.XML2_CV130Service.BaseParameter.ListYear = this.DownloadService.ListYear();
    this.XML2_CV130Service.BaseParameter.ListMonth = this.DownloadService.ListMonth();
  }
  XML2_CV130Search() {
    this.XML2_CV130Service.IsShowLoading = true;
    this.XML2_CV130Service.GetByYear_Month_SearchStringToListAsync().subscribe(
      res => {
        this.XML2_CV130Service.List = (res as XML2_CV130[]).sort((a, b) => (a.NGAY_YL > b.NGAY_YL ? 1 : -1));
